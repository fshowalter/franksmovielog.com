...
function ViewingListItem({ value }: { value: ListItemValue }): JSX.Element {
  ...
  return (
    <li
      className="relative mb-1 flex flex-row items-center gap-x-4 bg-default px-container py-4 last-of-type:mb-0 has-[a:hover]:bg-subtle tablet:gap-x-6 tablet:pl-4"
      style={{
