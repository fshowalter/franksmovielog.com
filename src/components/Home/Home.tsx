    ...
    <Layout hideLogo={true} className="bg-subtle pb-8">
      ...
      <nav className="mx-auto max-w-screen-max px-container">
        ...
        <div className="flex py-10">
          <a
            href="/reviews/"
            className="mx-auto w-full max-w-[430px] bg-default py-5 text-center font-sans-narrow text-sm font-semibold uppercase tracking-[.6px] text-accent hover:bg-accent hover:text-inverse"
          >
            All Reviews
          </a>
        </div>
