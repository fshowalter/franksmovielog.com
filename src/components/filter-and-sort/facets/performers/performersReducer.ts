...
const ActionTypes = {
  CHANGED: "performers/changed" as const,
};

export const STATE_KEY = "performers";

export type PerformersFilterChangedAction = {
  type: typeof ActionTypes.CHANGED;
  values: readonly string[];
};

export function createPerformersFilterChangedAction(
  values: readonly string[],
): PerformersFilterChangedAction {
  return { type: ActionTypes.CHANGED, values };
}

export function performersFacetReducer<
