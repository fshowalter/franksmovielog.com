...
type GenresFilterItem = FilterableValue & { title: string };
 ...
 */
export function genresFilterTests(
  renderItems: (items: GenresFilterItem[]) => void,
  getList: () => HTMLElement,
): void {
