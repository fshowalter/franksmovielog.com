        ...
        >
          ...
          <dialog
            ...
            className={`
              ...
              max-h-full max-w-[380px] translate-x-full overflow-hidden border-0
              bg-default p-0 text-left drop-shadow-2xl transition-all
          ...
          >
            ...
            >
              ...
              <div
                className={`
                  sticky bottom-0 z-above mt-auto w-full translate-y-full
