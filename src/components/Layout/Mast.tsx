...
export function Mast({
  ...
  return (
    <header
      className="mast z-20 flex w-full items-center justify-between px-[8%] py-4 tablet:px-8 tablet:py-6 desktop:inset-x-0 desktop:z-40 desktop:flex-row desktop:flex-wrap desktop:px-16 desktop:py-8 desktop:text-left"
      style={{
