...
function MostWatchedPersonViewingListItem({
  ...
  return (
    <li
      className={`${value.slug ? "bg-default" : "bg-unreviewed"} relative mb-1 flex max-w-screen-max flex-row gap-x-4 py-4 has-[a:hover]:bg-subtle tablet:gap-x-6 tablet:px-4 desktop:px-6`}
    >
