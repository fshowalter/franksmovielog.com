...
describe("MultiSelectField", () => {
  describe("rendering", () => {
    it("displays label and placeholder text", ({ expect }) => {
  ...
  describe("dropdown interactions", () => {
    it("opens dropdown when button is clicked", async ({ expect }) => {
  ...
  describe("selecting options", () => {
    ...
    it("removes selected option from available list", async ({ expect }) => {
      const onChange = vi.fn();
      const user = userEvent.setup();
      const props = createDefaultProps({ onChange });
      render(<MultiSelectField {...props} />);
    ...
    it("selects multiple options", async ({ expect }) => {
      const onChange = vi.fn();
      const user = userEvent.setup();
      const props = createDefaultProps({ onChange });
      render(<MultiSelectField {...props} />);
  ...
  describe("keyboard navigation", () => {
    ...
    describe("selecting options with keyboard", () => {
    ...
    describe("updating available options", () => {
  ...
  describe("dropdown positioning", () => {
    ...
    it("calculates dropdown height based on available options", async ({
      ...
      const props = createDefaultProps({ options: fewOptions });
    ...
    describe("when insufficient space below", () => {
      it("positions dropdown above when space is available above", ({
        expect,
      }) => {
