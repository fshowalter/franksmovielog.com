...
function WatchlistListItem({
  ...
  return (
    <li className="relative flex max-w-screen-max flex-row items-center gap-x-4 bg-subtle px-container py-4 odd:bg-stripe tablet:gap-x-6 tablet:px-4 desktop:px-6">
