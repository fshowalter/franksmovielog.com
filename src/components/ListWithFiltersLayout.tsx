...
export function SubNav({ values }: { values: SubNavValue[] }) {
  return (
    <nav className="bg-footer">
      <ul className="scrollbar-hidden mx-auto flex max-w-screen-max overflow-x-auto px-container font-sans text-sm font-semibold uppercase tracking-wider desktop:justify-center">
        {values.map((value) => {
          return (
            <li
